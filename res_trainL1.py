...
import argparse
from res_define import resnet18
from res_define import Regularization
import os
import numpy as np
...
#optimizer = optim.Adam(net.parameters(), lr=LR, betas=(0.9,0.999),eps=1e-08, weight_decay=0.000001) L2 NORM
